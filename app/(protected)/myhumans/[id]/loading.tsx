    ...
    <div className="px-4 py-5 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-card rounded-xl shadow-sm p-4 md:p-6">
        <div className="border-l-4 border-blue-600 bg-blue-50/40 rounded-r-xl p-5 space-y-3">
          ...
          <div className="bg-card/80 rounded-lg border border-blue-100 p-4 space-y-2">
      ...
      <div className="bg-card rounded-xl shadow-sm p-4 md:p-6">
        ...
        <div className="space-y-2">
          {[1, 2].map((i) => (
            <div key={i} className="flex items-center gap-3 px-3 py-2.5 border border-border rounded-lg">
